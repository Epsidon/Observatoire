...
+ translator.T(" is part of the ") + 
"${GeoKey20_2}"+ "&nbsp" + "(" + "${GeoKey20_1}" + ")" + translator.T(" Local Health Integration Network (LHIN).") +
"<p>" +  
...
layerData[4] = [];
layerData[4]['infoWindowTitle'] = "<b>" + translator.T("Health Professionals By LHIN") + "</b>";
layerData[4]['infoWindowBody'] = "${HR035b08_E}" + "&nbsp" + "(" + "${HR035b08_H}" + ")" + "<p>"+ "<b>"+ translator.T("Total Population in 2011:") + "&nbsp" + "</b>" + "${LHINProf_2}" + "<br>" + "</p>" + 
"<table border=1>"+
"<tr>"+
...
"<b>" + "<p>" + translator.T("Taux global de non-réponse (TNR) = ") + "</b>" + "${SociEcoProfile.csv.TGN}" + "</p>" +
"<table border=1>"+
"<tr>"+
"<th align='center'></th>"+
...
"</tr>"+
"<tr>" +
"<td class=first align='center'>" + translator.T("Proportion de la population totale") + "</td>"+
...
"</tr>"+
"<tr>" +
"<td class=first align='center'>" + translator.T("Groupes d'age") + "</td>"+
"</tr>"+
"<tr>" +
"<td class=first align='center'>" + translator.T("0 à 19 ans") + "</td>"+
...
"</tr>"+
"<tr>" +
"<td class=first align='center'>" + translator.T("20 à 64 ans") + "</td>"+
...
"</tr>"+
"<tr>" +
"<td class=first align='center'>" + translator.T("65 ans et plus") + "</td>"+
...
"</tr>"+
"<tr>" +
"<td class=first align='center'>" + translator.T("Aucun certificat, diplôme ou grade") + "</td>"+
...
"</tr>"+
"<tr>" +
"<td class=first align='center'>" + translator.T("Diplôme d'études secondaires") + "</td>"+
...
"</tr>"+
"<tr>" +
"<td class=first align='center'>" + translator.T("Certificat/diplôme d'un collège") + "</td>"+
...
"</tr>"+
"<tr>" +
"<td class=first align='center'>" + translator.T("Certificat/diplôme universitaire") + "</td>"+
...
"</tr>"+
"<tr>" +
"<td class=first align='center'>" + translator.T("Personne à faible revenu") + "</td>"+
...
"</tr>"+
"<tr>" +
"<td class=first align='center'>" + translator.T("Personne vivant seule") + "</td>"+
...
layerData[6] = [];
layerData[6]['infoWindowTitle'] = "<b>" + translator.T("All Hospitals") + "</b>";
layerData[6]['infoWindowBody'] ="${LHIN_NAME}"+ "&nbsp" + "(" + "${LHINInfo_1}" + ")" + "<p>" + "<b>" + translator.T("Total Population in 2011:") + "&nbsp" + "</b>" + "${LHINProf_2}"+ "</p>" +"<p><b>"+ "<p>" + "<table border=1>"+ "</p>" +
"<tr>"+
...
layerData[7] = [];
layerData[7]['infoWindowTitle'] = "<b>" + translator.T("General Rehabilitation Hospital") + "</b>";
layerData[7]['infoWindowBody'] =  "${LHIN_NAME}"+ "&nbsp" + "(" + "${LHINInfo_1}" + ")" + "<p>" + "<b>" + translator.T("Total Population in 2011:") + "&nbsp" + "</b>" + "${LHINProf_2}"+ "</p>" +"<p><b>"+ "<p>" + "<table border=1>"+ "</p>" +
"<tr>"+
"<th align='center'>Health Unit Name</th>"+
"<th align='center'>City</th>"+
"<th align='center' >Address</th>"+
...
layerData[8] = [];
layerData[8]['infoWindowTitle'] = "<b>" + translator.T("Mental Health Unit") + "</b>";
layerData[8]['infoWindowBody'] = "${LHIN_NAME}"+ "&nbsp" + "(" + "${LHINInfo_1}" + ")" + "<p>" + "<b>" + translator.T("Total Population in 2011:") + "&nbsp" + "</b>" + "${LHINProf_2}"+ "</p>" +"<p><b>"+ "<p>" + "<table border=1>"+ "</p>" +
"<tr>"+
"<th align='center'>Health Unit Name</th>"+
"<th align='center'>City</th>"+
"<th align='center'>Address</th>"+
...
layerData[9] = [];
layerData[9]['infoWindowTitle'] = "<b>" + translator.T("Special Rehabilitation Hospital") + "</b>";
layerData[9]['infoWindowBody'] ="${LHIN_NAME}"+ "&nbsp" + "(" + "${LHINInfo_1}" + ")" + "<p>" + "<b>" + translator.T("Total Population in 2011:") + "&nbsp" + "</b>" + "${LHINProf_2}"+ "</p>" +"<p><b>"+ "<p>" + "<table border=1>"+ "</p>" +
"<tr>"+
"<th align='center'>Health Unit Name</th>"+
"<th align='center'>City</th>"+
"<th align='center'>Address</th>"+
...
layerData[10] = [];
layerData[10]['infoWindowTitle'] = "<b>" + translator.T("Acute Care Treatment Hospital") + "</b>";
layerData[10]['infoWindowBody'] = "${LHIN_NAME}"+ "&nbsp" + "(" + "${LHINInfo_1}" + ")" + "<p>" + "<b>" + translator.T("Total Population in 2011:") + "&nbsp" + "</b>" + "${LHINProf_2}"+ "</p>" +"<p><b>"+ "<p>" + "<table border=1>"+ "</p>" +
"<tr>"+
"<th align='center'>Health Unit Name</th>"+
"<th align='center'>City</th>"+
"<th align='center'>Address</th>"+
...
layerData[11] = [];
layerData[11]['infoWindowTitle'] = "<b>" + translator.T("Ambulatory Care") + "</b>";
layerData[11]['infoWindowBody']= "${LHIN_NAME}"+ "&nbsp" + "(" + "${LHINInfo_1}" + ")" + "<p>" + "<b>" + translator.T("Total Population in 2011:") + "&nbsp" + "</b>" + "${LHINProf_2}"+ "</p>" +"<p><b>"+ "<p>" + "<table border=1>"+ "</p>" +
"<tr>"+
"<th align='center'>Health Unit Name</th>"+
"<th align='center'>City</th>"+
"<th align='center'>Address</th>"+
...
layerData[12] = [];
layerData[12]['infoWindowTitle'] = "<b>" + translator.T("Chronic Care Treatment Hospital") + "</b>";
layerData[12]['infoWindowBody'] ="${LHIN_NAME}"+ "&nbsp" + "(" + "${LHINInfo_1}" + ")" + "<p>" + "<b>" + translator.T("Total Population in 2011:") + "&nbsp" + "</b>" + "${LHINProf_2}"+ "</p>" +"<p><b>"+ "<p>" + 
"<table border=1>"+ "</p>" +
"<tr>"+
"<th align='center'>Health Unit Name</th>"+
"<th align='center'>City</th>"+
...
layerData[14] = [];
layerData[14]['infoWindowTitle'] = "<b>" + translator.T("Ontario") + "</b>";
layerData[14]['infoWindowBody'] ="${HR035b08_E}"+ "&nbsp" + "(" + "${HR035b08_H}" + ")" + 
 "<p>" + "<a href=http://216.48.92.42:8080/notes.html target=_blank >" + translator.T("Methodological Notes") + "</a>" + "</p>";
layerData[14]['outFields'] = new Array("HR035b08_E", "HR035b08_H" );

layerData[13] = [];
layerData[13]['infoWindowTitle'] = "<b>" + translator.T("Champlain Local Health Integration Network (LHIN)") + "</b>";
...
"<p>" + translator.T("Champlain Global non-response rate (GNR) = ") + "${SociEcoP_1}"+ "</p>" +
